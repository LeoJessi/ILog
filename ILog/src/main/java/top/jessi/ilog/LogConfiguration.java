...
public class LogConfiguration {
     ...
     * 是否打印日志位置
     */
    public final boolean bePrintPosition;
    ...
    /*package*/ LogConfiguration(final Builder builder) {
        ...
        bePrintPosition = builder.bePrintPosition;
    ...
    public static class Builder {
        ...
        private boolean bePrintPosition;
        ...
        public Builder(LogConfiguration logConfiguration) {
            ...
            bePrintPosition = logConfiguration.bePrintPosition;
        ...
        public Builder enablePrintPosition() {
            this.bePrintPosition = true;
            return this;
        }

        public Builder disablePrintPosition() {
            this.bePrintPosition = false;
            return this;
        }
