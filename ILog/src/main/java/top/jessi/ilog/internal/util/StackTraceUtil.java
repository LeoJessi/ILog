...
package top.jessi.ilog.internal.util;
...
public class StackTraceUtil {
    ...
    private static final String ILOG_STACK_TRACE_ORIGIN;

    static {
        // Let's start from xlog library.
        String ilogClassName = ILog.class.getName();
        ILOG_STACK_TRACE_ORIGIN = ilogClassName.substring(0, ilogClassName.lastIndexOf('.') + 1);
    }
    ...
    private static StackTraceElement[] getRealStackTrack(StackTraceElement[] stackTrace,
        ...
        for (int i = allDepth - 1; i >= 0; i--) {
            ...
            if (className.startsWith(ILOG_STACK_TRACE_ORIGIN)
