...
public class LogUtils {
  ...
  public static String formatJson(String json) {
    ...
    return ILog.sLogConfiguration.jsonFormatter.format(json);
  }
  ...
  public static String formatXml(String xml) {
    ILog.assertInitialization();
    return ILog.sLogConfiguration.xmlFormatter.format(xml);
  }
  ...
  public static String formatThrowable(Throwable throwable) {
    ILog.assertInitialization();
    return ILog.sLogConfiguration.throwableFormatter.format(throwable);
  }
  ...
  public static String formatThread(Thread thread) {
    ILog.assertInitialization();
    return ILog.sLogConfiguration.threadFormatter.format(thread);
  }
  ...
  public static String formatStackTrace(StackTraceElement[] stackTrace) {
    ILog.assertInitialization();
    return ILog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
  }
  ...
  public static String addBorder(String[] segments) {
    ILog.assertInitialization();
    return ILog.sLogConfiguration.borderFormatter.format(segments);
  }
