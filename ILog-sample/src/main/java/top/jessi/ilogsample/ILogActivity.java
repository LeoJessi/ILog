...
public class ILogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPrinter = new RecyclerPrinter(logContainer);

        // Print welcome message.
        ILog.printers(viewPrinter).i("XLog is ready.\nPrint your log now!");
    ...
    protected void onResume() {
        ...
        ILog.printers(viewPrinter).i(message);
    }
    ...
    private void printLog() {
        ...
        if (hasPermission) {
            builder.printers(
                    viewPrinter,
                    new AndroidPrinter(),
                    ILogSampleApplication.globalFilePrinter);
        } else {
            builder.printers(
                    viewPrinter,
                    new AndroidPrinter());
